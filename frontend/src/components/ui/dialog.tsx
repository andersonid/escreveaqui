...
>(({ className, children, ...props }, ref) => (
  <DialogPrimitive.Portal>
    ...
    >
      {children}
      <DialogClose className="absolute right-4 top-4 rounded-sm opacity-60 transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2">
        <X className="h-4 w-4" />
